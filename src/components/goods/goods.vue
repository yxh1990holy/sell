<template>
	<div>
							...
							<li v-for="food in item.foods" class="food-item border-1px" @click="selectFood(food, $event)">
								...
								<div class="content">
									...
									<div class="cartcontrol-wrapper">
										<!-- 此处@cart-add="addCart"是将cart-add事件传递给cartcontrol.vue子组件调用(goods页面“+”按钮的小球效果) -->
		...
		<!-- 此处@cart-add="addCart"是将cart-add事件传递给food.vue子组件调用(food页面“添加购物车”按钮的小球效果) -->
...
<script type="text/ecmascript-6">
	...
	export default {
		...
		methods: {
			...
			// addCart(target) {
			// 	// console.log('调用到goods.vue中的cartAdd方法');
			// 	//体验优化，异步执行下落动画
			// 	this.$nextTick(() => {
			...
			// selectMenu(index, event) {
				...
				// 	return;
				// }
				// 将选择的food负值给selectedFood并通过标签中:food="selectedFood"传递给子组件food.vue中food
				this.selectedFood = food;
				// 通过在标签中添加ref="food"调用子组件food.vue中的show()方法
				this.$refs.food.show();
			}
		}
	}
