...
<script type="text/ecmascript-6">
	...
	export default {
		...
		methods: {
			needShow(type, text) {
				// console.log("id:"+id+"ratings.vue-needshow():type:"+type+";text:"+text);
				// console.log("id:"+id+"ratings.vue-needshow():selectType+"+this.selectType:";onlyContent:"+this.onlyContent);
			...
			incrementTotal(type, data) {
				...
				// console.log("ratings.vue-incrementTotal():type:"+type+";data:"+data);
			}
		},
		created () {
